...
public class TestBaseSequence {
  ...
  public void initInvalidDNA() {
    ...
    assertEquals("Failed to detect invalid DNA sequence.", "One or more invalid characters in sequence.\n", dna.toString()); //stdout
  }
  ...
  public void transcribeRNA() {
    ...
    dna.transcribe();
    assertEquals("Failed to show RNA transcription error.", "Can only transcribe DNA sequences.\n", stdout.toString());
  }
  ...
  public void clipStartLessThanZero() {
    dna = new BaseSequence("ACGTACG", SequenceType.DNA);
    dna.clip(-1,4);
    assertEquals("Failed to detect invalid sequence clip start", "Unable to clip fragment starting at -1.\nStart must be between 0 and 6.\n", stdout.toString());
  }
  ...
  public void clipStartMoreThanLength() {
    dna = new BaseSequence("ACGTACG", SequenceType.DNA);
    dna.clip(7,0);
    assertEquals("Failed to detect invalid sequence clip start", "Unable to clip fragment starting at 7.\nStart must be between 0 and 6.\n", stdout.toString());
  }
  ...
  public void clipEndMoreThanLength() {
    dna = new BaseSequence("ACGTACG", SequenceType.DNA);
    dna.clip(2,7);
    assertEquals("Failed to detect invalid sequence clip end", "Unable to clip fragment ending at 7.\nEnd must be less than or equal to 6.\n", stdout.toString());
  }
}
